...
namespace Pixils::UI
{
  namespace
  {
      ...
      Roo::Runtime& runtime)
    {
      ...
      Runtime::pull_bound_view_state(view, runtime);
      ...
      Runtime::push_bound_view_state(view, runtime);
    }
