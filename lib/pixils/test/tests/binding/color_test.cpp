...
{
  Lisple::sptr_val result = runtime.eval("(pixils.color/make-color \"#FaC988\")");
...
{
  Lisple::sptr_val result = runtime.eval("(pixils.color/make-color \"#AbC\")");
...
{
  Lisple::sptr_val result = runtime.eval("pixils.color/REBECCA-PURPLE");
...
{
  Lisple::sptr_val result = runtime.eval("pixils.color/TRANSPARENT");
