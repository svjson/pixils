...
TEST_F(BootstrapTest, loads_embedded_core_ui_definitions_into_separate_registries)
{
  ...
  auto checkbox_component =
    Roo::Dict::get_property(components, Roo::symbol("ui/checkbox"));
  ...
  auto menu_bar_component =
    Roo::Dict::get_property(components, Roo::symbol("ui/menu-bar"));
  auto popup_menu_mode = Roo::Dict::get_property(modes, Roo::symbol("ui/popup-menu"));
  auto list_box_component =
    Roo::Dict::get_property(components, Roo::symbol("ui/list-box"));
  ...
  auto slider_component =
    Roo::Dict::get_property(components, Roo::symbol("ui/slider"));
  ...
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*rich_text_component).name,
            "ui/rich-text");
  ...
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*checkbox_component).name,
            "ui/checkbox");
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*scrollbar_component).name,
            "ui/scrollbar");
  ...
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*header_panel_component).name,
            "ui/header-panel");
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*group_box_component).name,
            "ui/group-box");
  ...
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*menu_bar_component).name,
            "ui/menu-bar");
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Mode>(*popup_menu_mode).name, "ui/popup-menu");
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*list_box_component).name,
            "ui/list-box");
  EXPECT_EQ(Roo::obj<Pixils::Runtime::Component>(*combo_box_component).name,
            "ui/combo-box");
