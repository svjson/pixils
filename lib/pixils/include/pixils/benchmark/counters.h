...
namespace Pixils::Benchmark
{
  enum class MetricId : std::uint16_t
  {
    ...
    update_view_tree_calls,
    update_view_tree_nodes,
    update_hook_calls,
    update_hook_time_ns,
    update_state_extract_calls,
    update_state_extract_time_ns,
    update_state_merge_calls,
    update_state_merge_time_ns,
    update_interaction_checks,
    update_interaction_changes,
    layout_after_layout_hook_calls,
    layout_after_layout_hook_time_ns,
