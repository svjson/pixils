  ...
  Category layout_category()
  {
    return category("layout",
                    {MetricId::layout_view_tree_calls,
                     ...
                     MetricId::layout_after_layout_hook_calls,
                     MetricId::layout_after_layout_hook_time_ns,
                     MetricId::layout_after_layout_hook_state_changes,
                     MetricId::layout_passes,
  ...
  Category runtime_category()
  {
    return category("runtime",
                    {MetricId::runtime_push_mode_calls,
                     ...
                     MetricId::update_view_tree_calls,
                     MetricId::update_view_tree_nodes,
                     MetricId::update_hook_calls,
                     MetricId::update_hook_time_ns,
                     MetricId::update_state_extract_calls,
                     MetricId::update_state_extract_time_ns,
                     MetricId::update_state_merge_calls,
                     MetricId::update_state_merge_time_ns,
                     MetricId::update_interaction_checks,
                     MetricId::update_interaction_changes,
